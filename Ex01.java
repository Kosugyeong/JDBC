...
public class Ex01 {
	...
	public static void main(String[] args) {
		...
		/*
			...
			1. JDBCTest > "lib" 폴더 생성 > ojdbc6.jar 넣어놓기
			2. 현재 프로젝트에서 오른쪽 마우스 - Build path - Configure Build path - Class path에서 Add jar 하기 => 프로젝트에서 jar 참조
			...
			JDBC 라이브러리 클래스
			- Connectrion, Statement, ResultSet 클래스
